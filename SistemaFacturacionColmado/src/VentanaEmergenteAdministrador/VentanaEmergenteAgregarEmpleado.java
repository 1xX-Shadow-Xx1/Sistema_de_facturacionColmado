 ...
 * @author kevin
 */
public class VentanaEmergenteAgregarEmpleado extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(VentanaEmergenteAgregarEmpleado.class.getName());

    /**
     * Creates new form VentanaEmergenteAgrearEmpleado
     */
    public VentanaEmergenteAgregarEmpleado() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new VentanaEmergenteAgregarEmpleado().setVisible(true));
    }
